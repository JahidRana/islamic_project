...
<section>
        ...
        <div class="col-2">
            ...
            <div class="sidebar">
                ...
                <li>
                    ...
                    <li><a href="Delwar_hossain_saydee.php" class="btnsName activeClass">Delwar Hossain Sayeedi</a></li>
    ...
    require_once("./admin/config/connect.php");
        ...
        $query = "SELECT * FROM post where bokta_name='Delwar Hossain Sayeedi'
